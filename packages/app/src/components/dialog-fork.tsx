...
import type { TextPart as SDKTextPart } from "@duoduo-ai/sdk/v2/client"
...
export const DialogFork: Component = () => {
  ...
  const messages = createMemo((): ForkableMessage[] => {
    ...
    for (const message of msgs) {
      ...
      // Prefer summary.title (always in memory) over parts text (may be windowed out)
      const summaryText = message.summary?.title || message.summary?.body
