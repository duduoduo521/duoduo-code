...
const DEFAULT_USERNAME = "duoduocode"
...
export function DialogSelectServer() {
  ...
  const handleAddChange = (value: string) => {
    ...
    setStore("addServer", { url: value, error: isHttpNonLocal ? language.t("dialog.server.add.httpWarning") : "" })
  ...
  const handleEditChange = (value: string) => {
    ...
    setStore("editServer", { value, error: isHttpNonLocal ? language.t("dialog.server.add.httpWarning") : "" })
