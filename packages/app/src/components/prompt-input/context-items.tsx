...
import { getDirectory, getFilename, getFilenameTruncated } from "@duoduo-ai/shared/util/path"
          ...
          {(item) => {
            ...
            return (
              <Tooltip
                value={
                  <span class="flex max-w-[300px]">
                    <span class="text-text-weak truncate-start [unicode-bidi:plaintext] min-w-0">{directory}</span>
              ...
              >
                <div
                  classList={{
                    "group shrink flex flex-col rounded-[6px] pl-2 pr-1 py-1 max-w-[200px] h-12 cursor-default transition-all transition-transform shadow-xs-border hover:shadow-xs-border-hover": true,
                ...
                >
                  <div class="flex items-center gap-1.5">
                    ...
                    <div class="flex items-center text-11-regular min-w-0 font-medium flex-1 min-w-0">
                      <span class="text-text-strong truncate min-w-0">{label}</span>
