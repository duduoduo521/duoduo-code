...
import type { VcsInfo } from "@duoduo-ai/sdk/v2/client"
import {
  DIR_IDLE_TTL_MS,
  MAX_DIR_STORES,
  type ChildOptions,
...
import { getOrCreateFileTree, disposeFileTree, type FileTreeEntry } from "./file-tree-cache"
...
export function createChildStoreManager(input: {
  ...
  const fileTreeCache = new Map<string, FileTreeEntry>()
  ...
  function disposeDirectory(directory: string) {
    ...
    fileTreeCache.delete(directory)
    lifecycle.delete(directory)
    disposeFileTree(directory)
