export const dict = {
  ...
  "settings.providers.disconnectConfirm.title": "Disconnect provider",
  "settings.providers.disconnectConfirm.message": "The saved API key for \"{{provider}}\" will be deleted; reconnect to use it again.",
  "settings.providers.disconnectConfirm.confirm": "Disconnect",
  "session.revertConfirm.title": "Revert message",
  "session.revertConfirm.message": "This reverts this message and everything generated after it.",
  "session.revertConfirm.confirm": "Revert",
  ...
  "workspace.deleteProject.indexCleanFailed": "Failed to clean up the knowledge-graph index",
  "workspace.sessionMissing": "Session does not exist or has been deleted",
  ...
  "memory.profile.loadFailed": "Failed to load memory profiles",
  "memory.patterns.loadFailed": "Failed to load learning patterns",
