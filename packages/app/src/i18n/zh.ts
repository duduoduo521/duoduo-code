...
export const dict = {
  ...
  "provider.custom.testFailed": "模型连通性测试失败，请检查 baseURL / API Key 或代理设置",
  ...
  "project.remote.openFailed.timeout": "打开项目超时：后端未在规定时间内就绪，请检查 duoduocode 侧车进程。",
  ...
  "prompt.slash.gearDescription": "激活智械 {{name}}",
  "prompt.tps": "上轮速度: {{speed}} token/s",
  ...
  "settings.providers.disconnectConfirm.title": "断开 Provider",
  "settings.providers.disconnectConfirm.message": "将删除「{{provider}}」已保存的 API Key，之后需要重新连接才能再次使用。",
  "settings.providers.disconnectConfirm.confirm": "断开",
  "session.revertConfirm.title": "撤回消息",
  "session.revertConfirm.message": "将撤回这条消息及其之后生成的内容。",
  "session.revertConfirm.confirm": "撤回",
  ...
  "settings.snapshot.compaction": "上下文压缩",
  "settings.snapshot.compactionAuto": "自动压缩",
  "settings.snapshot.compactionPrune": "清理旧工具输出",
  "settings.snapshot.compactionSaved": "压缩设置已保存",
  ...
  "settings.webfetch.title": "网络访问控制",
  "settings.webfetch.description": "管理 AI 抓取网页内容时允许访问的地址范围（黑名单 / 白名单），规则在每次重定向跳转时都会重新生效",
  "settings.webfetch.mode": "访问模式",
  "settings.webfetch.modeDesc": "黑名单：默认放行所有公网地址，命中拦截规则的地址除外（标准保留地址段已预置，可任意增删改）。白名单：只允许命中放行规则的地址（例如只允许访问内网），其余全部拦截。",
  "settings.webfetch.modeBlacklist": "黑名单模式",
  "settings.webfetch.modeWhitelist": "白名单模式",
  "settings.webfetch.modeBlacklistDesc": "当前：默认放行，命中“拦截”规则的地址会被拒绝。",
  "settings.webfetch.modeWhitelistDesc": "当前：默认拦截，只有命中“放行”规则的地址可以访问。",
  "settings.webfetch.rules": "规则列表",
  "settings.webfetch.rulesDesc": "支持 IP、CIDR 段（如 10.0.0.0/8）、域名（如 example.com）与通配域名（如 *.internal）。更精确的规则优先；同为精确时“放行”优先于“拦截”。",
  "settings.webfetch.empty": "暂无规则。",
  "settings.webfetch.patternPlaceholder": "IP / CIDR / 域名 / *.域名",
  "settings.webfetch.addRule": "添加规则",
  "settings.webfetch.allow": "放行",
  "settings.webfetch.block": "拦截",
  "settings.webfetch.enabled": "已启用",
  "settings.webfetch.disabled": "已停用",
  "settings.webfetch.delete": "删除",
  "settings.webfetch.invalidPattern": "规则格式无效（不允许空格，需为 IP / CIDR / 域名）",
  "settings.webfetch.save": "保存设置",
  "settings.webfetch.saved": "网络访问控制设置已保存",

  "session.revertPartialFailed": "部分文件回滚失败",
  ...
  "market.detail.title": "智械详情",
  "market.detail.viewOnModelscope": "在 ModelScope 查看 ↗",
  "gearStore.files": "文件",
  ...
  "workspace.deleteProject.indexCleanFailed": "知识图谱索引清理失败",
  "workspace.sessionMissing": "会话不存在或已删除",
  ...
  "memory.profile.loadFailed": "记忆档案加载失败",
  "memory.patterns.loadFailed": "学习模式加载失败",
