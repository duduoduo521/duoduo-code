  ...
  parsers: [
    ...
    },
    {
      ...
      queries: {
        ...
        // Enable JS/CSS syntax highlighting inside <script>/<style> tags.
        // `injectionMapping` is part of the opentui FiletypeParserOptions API
        // (see @opentui/core lib/tree-sitter/types.d.ts). Runtime correctness depends on
        // the tree-sitter-html injections.scm query being reachable at the URL below.
        injections: [
    ...
    {
      filetype: "nix",
      // Using a temporary ast-grep WASM until official tree-sitter-nix is published.
