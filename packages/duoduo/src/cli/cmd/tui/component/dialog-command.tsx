...
// oxlint-disable-next-line no-redundant-type-constituents -- DialogSelectOption<string> resolves to an error/any type under the ts7 preview; the intersection members are intentional
