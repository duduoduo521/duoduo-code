...
import type { AssistantMessage, FilePart, UserMessage } from "@duoduo-ai/sdk/v2"
...
export function Prompt(props: PromptProps) {
  ...
  // Exit shell mode, returning to the normal prompt input.
  const exitShellMode = () => setStore("mode", "normal")
