...
const TIPS = [
  ...
  "Use {highlight}duoduo run{/highlight} for non-interactive scripting",
  "Use {highlight}duoduo --continue{/highlight} to resume the last session",
  "Use {highlight}duoduo run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}duoduo serve{/highlight} for headless API access to DuoDuoCode",
  "Use {highlight}duoduo run --attach{/highlight} to connect to a running server",
  "Run {highlight}duoduo upgrade{/highlight} to update to the latest version",
  "Run {highlight}duoduo auth list{/highlight} to see all configured providers",
