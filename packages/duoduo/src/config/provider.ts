...
export const Model = Schema.Struct({
  ...
  supports_temperature: Schema.optional(Schema.Boolean),
  top_p: Schema.optional(Schema.Number),
  supports_top_p: Schema.optional(Schema.Boolean),
  tool_call: Schema.optional(Schema.Boolean),
  prompt_caching: Schema.optional(Schema.Boolean).annotate({
    description: "Whether this model's provider supports prompt caching (cache_control). Auto-detected on add.",
  }),
