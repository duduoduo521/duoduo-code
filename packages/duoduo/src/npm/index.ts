...
import { Global } from "@duoduo-ai/shared/global"
...
export class Service extends Context.Service<Service, Interface>()("@duoduocode/Npm") {}
...
// @effect-diagnostics-next-line unnecessaryFailYieldableError:off
      if (!first) return yield* Effect.fail(new InstallFailedError({ add: [pkg], dir }))
