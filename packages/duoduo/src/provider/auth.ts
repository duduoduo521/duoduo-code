import type { AuthOAuthResult, Hooks } from "@duoduo-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@duoduocode/ProviderAuth") {}
  ...
  Effect.gen(function* () {
    ...
    const authorize = Effect.fn("ProviderAuth.authorize")(function* (
      ...
      const result = yield* Effect.promise(() =>
        (method as { authorize: (inputs: Record<string, string>) => Promise<AuthOAuthResult> }).authorize(
          input.inputs ?? {},
        ),
      )
