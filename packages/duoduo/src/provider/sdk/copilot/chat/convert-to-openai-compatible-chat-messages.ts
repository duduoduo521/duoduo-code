    ...
    switch (role) {
      ...
      case "assistant": {
        ...
        messages.push({
          ...
          // DeepSeek/Qwen/Kimi emit and require `reasoning_content` on the assistant
          // turn for multi-turn reasoning continuity; emit it whenever reasoning text
          // exists. Copilot keeps using reasoning_text/reasoning_opaque (untouched).
