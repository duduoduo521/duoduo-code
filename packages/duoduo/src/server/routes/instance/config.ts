  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current DuoDuoCode configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update DuoDuoCode configuration settings and preferences.",
