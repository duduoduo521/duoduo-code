...
export class Service extends Context.Service<Service, Interface>()("@duoduocode/Truncate") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const cleanup = Effect.fn("Truncate.cleanup")(function* () {
      const cutoffKey = Identifier.sortKey(
      ...
      for (const entry of entries) {
        if (Identifier.sortKey(entry) >= cutoffKey) continue
