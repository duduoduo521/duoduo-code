...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/duoduo.git")).toEqual({ owner: "sst", repo: "duoduo" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/duoduo")).toEqual({ owner: "sst", repo: "duoduo" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/duoduo.git")).toEqual({ owner: "sst", repo: "duoduo" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/duoduo")).toEqual({ owner: "sst", repo: "duoduo" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/duoduo.git")).toEqual({ owner: "sst", repo: "duoduo" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/duoduo")).toEqual({ owner: "sst", repo: "duoduo" })
})
