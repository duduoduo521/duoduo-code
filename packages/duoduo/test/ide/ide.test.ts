...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DUODUO_CALLER", () => {
    process.env["DUODUO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DUODUO_CALLER", () => {
    process.env["DUODUO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DUODUO_CALLER", () => {
    process.env["DUODUO_CALLER"] = "unknown"
