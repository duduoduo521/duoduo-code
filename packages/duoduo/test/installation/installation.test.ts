  ...
  describe("latest", () => {
    ...
    test("reads brew formulae API versions", async () => {
      const layer = testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("duoduo-ai/tap/duoduocode")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("duoduocode")) return "duoduocode"
          return ""
        },
      )
    ...
    test("reads brew tap info JSON via CLI", async () => {
      ...
      const layer = testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("duoduo-ai/tap/duoduocode") && args.includes("--formula")) return "duoduocode"
