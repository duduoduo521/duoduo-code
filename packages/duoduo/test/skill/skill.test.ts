...
const withHome = <A, E, R>(home: string, self: Effect.Effect<A, E, R>) =>
  Effect.acquireUseRelease(
    Effect.sync(() => {
      const prev = process.env.DUODUO_TEST_HOME
    ...
    (prev) =>
      Effect.sync(() => {
        process.env.DUODUO_TEST_HOME = prev
      }),
  )

describe("skill", () => {
  it.live("discovers skills from .duoduo/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".duoduo", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".duoduo", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".duoduo", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .duoduo/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".duoduo", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".duoduo", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".duoduo", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".duoduo", "skill", "agent-skill", "SKILL.md"),
                `---
name:.duoduo-skill
description: A skill in the .duoduo/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".duoduo", "skills", "agent-skill", "SKILL.md"),
                `---
name:.duoduo-skill
description: A skill in the .duoduo/skills directory.
---
