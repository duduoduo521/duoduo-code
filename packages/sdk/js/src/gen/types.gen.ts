...
export type Config = {
  ...
  /**
   * Command configuration, see https://duoduocode.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://duoduocode.ai/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
...
export type SessionPromptData = {
  body?: {
     ...
     * Rust's runLoop so sub-agents treat `Ask` as `Allow`.
     */
    autoAccept?: boolean
    system?: string
    tools?: {
