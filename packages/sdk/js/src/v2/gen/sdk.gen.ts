...
import type {
  ...
  GraphReindexResponses,
  ImConfigGetResponses,
  ImConfigUpdateResponses,
  InstanceCapabilitiesResponses,
  ...
  PermissionRuleset,
  ProjectCleanupCountResponses,
  ProjectCleanupResponses,
  ProjectConnectRemoteErrors,
  ProjectConnectRemoteResponses,
  ProjectCreateRemoteErrors,
  ProjectCreateRemoteResponses,
  ProjectCurrentResponses,
  ProjectDisconnectRemoteErrors,
  ProjectDisconnectRemoteResponses,
  ProjectInitGitResponses,
  ProjectListResponses,
  ProjectOpenResponses,
  ProjectPullRemoteErrors,
  ProjectPullRemoteResponses,
  ProjectPushRemoteErrors,
  ProjectPushRemoteResponses,
  ProjectRemoteCheckResponses,
  ProjectRemoteListErrors,
  ProjectRemoteListResponses,
  ProjectUpdateErrors,
  ProjectUpdateRemoteCredentialErrors,
  ProjectUpdateRemoteCredentialResponses,
  ...
  SessionUpdateCascadeQaErrors,
  SessionUpdateCascadeQaGlobalErrors,
  SessionUpdateCascadeQaGlobalResponses,
  SessionUpdateCascadeQaResponses,
  SessionUpdateErrors,
  SessionUpdateResponses,
  SnapshotCleanupResponses,
  SnapshotStatsResponses,
  SubtaskPartInput,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new DuoDuoClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global DuoDuoCode configuration settings and preferences.
   */
   ...
   *
   * Update global DuoDuoCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the DuoDuoCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the DuoDuoCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all DuoDuoCode instances, releasing all resources.
   */
   ...
   * Graceful shutdown
   *
   * Gracefully shut down the DuoDuoCode server: dispose all instances, then exit the process.
   */
  public shutdown<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<GlobalShutdownResponses, unknown, ThrowOnError>({
      url: "/global/shutdown",
      ...options,
    })
  }
   ...
   * Upgrade duoduo
   *
   * Upgrade duoduo to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the DuoDuoCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the DuoDuoCode system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with DuoDuoCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that DuoDuoCode is working with.
   */
  ...
  /**
   * Open a project (create or refresh its record)
   *
   * Explicitly create or refresh the project record for a directory. This replaces the implicit boot-time creation so that cleanup can delete records without them being resurrected by instance boot (the sidecar is permanently bound to its launch directory).
   */
   ...
   *
   * Create a remote repository on GitHub or Gitee and add it as a git remote. Requires a valid access token for the target platform.
   */
  public createRemote<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ProjectCreateRemoteResponses, ProjectCreateRemoteErrors, ThrowOnError>(
      {
  ...
  /**
   * Connect a remote (SSH/SFTP) directory
   *
   * Mirror a remote directory locally and register it as a project (Plan C). Credentials are encrypted at rest. The local mirror is used as the project root, so the entire main code path runs against the mirror with no divergence.
   */
  public connectRemote<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      host?: string
  ...
  /**
   * Disconnect a remote (SSH/SFTP) project
   *
   * Disconnect a Plan C remote project. Always cleans up local traces: the project row, the local mirror directory, and the encrypted credential (secret + private-key file). This is a closed-loop disconnect. Set `deleteRemote: true` (a separate, explicit confirmation) to also recursively delete the files on the remote server — irreversible, so it is never the default.
   */
  public disconnectRemote<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      projectID?: string
  ...
  /**
   * Update SSH credentials of a remote project
   *
   * Update only the credentials (username / password / private key / auth kind) of an existing Plan C remote project. The connection identity (host/port/remotePath) is immutable, so no mirror / instance / session / KG state is affected. Safe to call on an already-open project.
   */
  public updateRemoteCredential<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      projectID?: string
   ...
   */
  public remoteList<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      host?: string
    ...
    return (options?.client ?? this.client).post<ProjectRemoteListResponses, ProjectRemoteListErrors, ThrowOnError>({
   ...
   */
  public pushRemote<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      projectID?: string
    ...
    return (options?.client ?? this.client).post<ProjectPushRemoteResponses, ProjectPushRemoteErrors, ThrowOnError>({
  ...
  /**
   * Pull remote changes into the local mirror (Plan C download)
   *
   * Downloads the remote tree of a remote (Plan C) project into the local mirror via SFTP. Detects git-style conflicts (local changed since last sync while remote also changed) and reports them without overwriting local changes.
   */
  public pullRemote<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      projectID?: string
    ...
    return (options?.client ?? this.client).post<ProjectPullRemoteResponses, ProjectPullRemoteErrors, ThrowOnError>({
  ...
  /**
   * Probe SSH reachability for a saved remote project
   *
   * Checks whether a saved Plan C remote project can still be reached, without pulling the tree or mutating local state. Used before opening a recent/sidebar SSH project so a dead server does not mount an empty session. Credentials are resolved server-side; no plaintext secret is ever returned.
   */
  public remoteCheck<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      projectID?: string
    ...
    return (options?.client ?? this.client).post<ProjectRemoteCheckResponses, unknown, ThrowOnError>({
  ...
  /**
   * Count project records that would be cleaned up
   *
   * Counts project records older than `days` (0 = all) that are eligible for cleanup. Projects currently open or present in the left sidebar (protectedWorktrees) are excluded.
   */
  public cleanupCount<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      days?: number
    ...
    return (options?.client ?? this.client).post<ProjectCleanupCountResponses, unknown, ThrowOnError>({
  ...
  public cleanup<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ProjectCleanupResponses, unknown, ThrowOnError>({
      url: "/project/cleanup",
      ...options,
      ...params,
      headers: {
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by DuoDuoCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current DuoDuoCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update DuoDuoCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all DuoDuoCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new DuoDuoCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific DuoDuoCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Provider extends HeyApiClient {
  ...
  /**
   * Scan LAN for model services
   *
   * Scan the local network for AI inference servers and auto-discover models.
   */
  public scanLan<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
    },
    ...
    return (options?.client ?? this.client).post<ProviderScanLanResponses, unknown, ThrowOnError>({
...
export class File extends HeyApiClient {
   ...
   * Write file
   *
   * Write content to a specified file. Creates the file and parent directories if they do not exist.
   */
   ...
   */
  public readDiff<ThrowOnError extends boolean = false>(
    parameters: {
      directory?: string
      workspace?: string
      path: string
    ...
    return (options?.client ?? this.client).get<FileReadDiffResponses, unknown, ThrowOnError>({
   ...
   * Create directory
   *
   * Create a directory (and any missing parents) at the specified path. Lets the file tree create real empty folders instead of writing a .gitkeep placeholder via the write endpoint. Idempotent: an existing directory is left as-is and reported with created=false.
   */
...
export class Config3 extends HeyApiClient {
   ...
   *
   * Get the current Feishu IM configuration. Secrets are masked.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ImConfigGetResponses, unknown, ThrowOnError>({
      url: "/im/im/config",
      ...options,
      ...params,
    })
   ...
   *
   * Update the IM configuration by writing to the project's .env.local file.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<ImConfigUpdateResponses, unknown, ThrowOnError>({
      url: "/im/im/config",
      ...options,
      ...params,
      headers: {
...
export class Graph extends HeyApiClient {
  ...
  public reindex<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<GraphReindexResponses, unknown, ThrowOnError>({
      url: "/graph/reindex",
      ...options,
      ...params,
      headers: {
...
export class Snapshot extends HeyApiClient {
   ...
   *
   * Return the disk usage of the file-snapshot repository for the current project.
   */
  public stats<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<SnapshotStatsResponses, unknown, ThrowOnError>({
      url: "/snapshot/stats",
      ...options,
      ...params,
    })
   ...
   *
   * Run garbage collection on the file-snapshot repository, dropping unreachable objects older than the given number of days.
   */
  public cleanup<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<SnapshotCleanupResponses, unknown, ThrowOnError>({
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current DuoDuoCode instance, releasing all resources.
   */
   ...
   *
   * Return directory routing capabilities for this DuoDuoCode instance.
   */
  public capabilities<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<InstanceCapabilitiesResponses, unknown, ThrowOnError>({
      url: "/capabilities",
      ...options,
      ...params,
    })
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the DuoDuoCode instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the DuoDuoCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Lsp extends HeyApiClient {
  ...
  public touch<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<LspTouchResponses, unknown, ThrowOnError>({
      url: "/lsp/touch",
      ...options,
      ...params,
    })
  ...
  public retry<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<LspRetryResponses, unknown, ThrowOnError>({
      url: "/lsp/retry",
      ...options,
      ...params,
    })
...
export class DuoDuoClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<DuoDuoClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    DuoDuoClient.__registry.set(this, args?.key)
  }
