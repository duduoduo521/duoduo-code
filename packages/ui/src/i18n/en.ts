export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.error.retry": "Retry",
  "ui.sessionTurn.error.contextTooLarge":
    "The conversation has grown too large for this model. Start a new session or switch to a model with a larger context window.",
  ...
  "ui.sessionTurn.status.stalled": "Response is slow — the model is still thinking, please wait…",
  "ui.sessionTurn.status.thinkingWithTopic": "Thinking - {{topic}}",
  "ui.sessionTurn.edit.send": "Send",
  "ui.sessionTurn.edit.cancel": "Cancel",
  "ui.sessionTurn.edit.hint": "Enter to send · Shift+Enter for newline · Esc to cancel",
  "ui.agentProgress.running": "Running {{tool}}…",
  "ui.agentProgress.pending": "Waiting for {{tool}}…",
  "ui.agentProgress.multiple": "{{count}} tools running…",
  "ui.agentProgress.statusRunning": "Running",
  ...
  "ui.app.loading": "Loading project...",
  ...
  "ui.tool.agent.type.explore": "Explore",
  "ui.tool.agent.type.build": "Build",
  "ui.tool.agent.type.plan": "Plan",
  "ui.tool.agent.type.general": "General",
  "ui.tool.agent.type.compaction": "Compaction",
  "ui.tool.agent.type.title": "Title",
  "ui.tool.agent.type.summary": "Summary",
  "ui.tool.agent.type.review": "Review",
  ...
  "ui.message.interrupted": "Stopped by user",
