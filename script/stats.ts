...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/duduoduo521/duoduo-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for duduoduo521/duoduo-code...\n")
...
console.log("Fetching npm all-time downloads for duoduo-ai...\n")
const npmDownloads = await fetchNpmDownloads("duoduo-ai")
